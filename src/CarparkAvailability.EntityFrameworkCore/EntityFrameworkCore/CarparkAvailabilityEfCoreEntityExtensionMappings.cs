...
{
    public static class CarparkAvailabilityEfCoreEntityExtensionMappings
    {
        ...
        public static void Configure()
        {
            ...
            OneTimeRunner.Run(() =>
            {
                 ...
                 * USE CarparkAvailabilityModuleExtensionConfigurator CLASS (in the Domain.Shared project)
