...
namespace CarparkAvailability.Web.Menus
{
    public class CarparkAvailabilityMenuContributor : IMenuContributor
    {
        private readonly IConfiguration _configuration;

        public CarparkAvailabilityMenuContributor(IConfiguration configuration)
        {
        ...
        private Task ConfigureMainMenuAsync(MenuConfigurationContext context)
        {
            ...
            var l = context.GetLocalizer<CarparkAvailabilityResource>();

            context.Menu.Items.Insert(
                0,
                new ApplicationMenuItem(
                    CarparkAvailabilityMenus.Home,
                    l["Menu:Home"],
                    "~/",
                    icon: "fas fa-home",
                    order: 0
